  ...
  return (
    <section id="WhatWeOffer" className="py-28 bg-white px-10 lg:px-16 xl:px-28 scroll-m-10">
      <div className="text-left">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-0 md:gap-8 items-start justify-center">
          <div className="mb-12">
          ...
          <div className="w-full lg:max-w-xl text-gray-600">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 w-full mt-10 gap-6 lg:gap-0">
          ...
          <div className="group flex flex-col items-start justify-start bg-white lg:px-6 py-2 border-none space-y-4">
